// pages/signup.js
// UPDATE — Phase 2: premium UI, Google OAuth, matches login page design.
...
export default function SignupPage() {
  ...
  // Already logged in — skip straight to app (unchanged)
  useEffect(() => {
    ...
    <>
      ...
      <div style={styles.page}>
        <div style={styles.card}>
          ...
          <p style={styles.sub}>Start with EDGEX — free, no credit card.</p>
